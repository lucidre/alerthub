...
class _UserHomeTabState extends State<UserHomeTab> {
  ...
  void onRefresh() async {
    final controller = Get.find<UserHomeTabController>();

    await Future.wait<dynamic>(
      [
        controller.getNearbyData(),
        controller.getOngoingData(),
        controller.getHospitalsData(),
      ],
    );
  ...
  Widget buildPanicSection() {
    return AppBtn.basic(
        onPressed: () => context.router.push(const PanicRoute()),
        child: Container(
  ...
  Widget buildSearchField() {
    return TextFormField(
      ...
      decoration: context.inputDecoration(
        hintText: 'Search events or hospitals nearby',
      ),
