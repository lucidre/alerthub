...
class AmbulanceAccoutSetupController extends GetxController {
  final UserService userService;
  AmbulanceAccoutSetupController(this.userService);
  ...
  TextEditingController get hospitalIdController => _hospitalIdController.value;
  TextEditingController get phoneNumberController =>
      _phoneNumberController.value;
  FocusNode get phoneNumberFocusNode => _phoneNumberFocusNode.value;
  FocusNode get hospitalIdFocusNode => _hospitalIdFocusNode.value;
  ...
  set hospitalIdController(TextEditingController value) =>
      _hospitalIdController.value = value;
  set phoneNumberFocusNode(FocusNode value) =>
      _phoneNumberFocusNode.value = value;
  set hospitalIdFocusNode(FocusNode value) =>
      _hospitalIdFocusNode.value = value;
  set formKey(GlobalKey<FormState> value) => _formKey.value = value;

  Future<void> signUpAmbulance() async {
