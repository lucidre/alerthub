...
class AppRouter extends RootStackRouter {
  ...
  List<AutoRoute> get routes => [
        ...
        AutoRoute(page: UserAccountSetupRoute.page),
        AutoRoute(page: UserSignUpRoute.page),
        AutoRoute(page: UserForgotPasswordRoute.page),
        AutoRoute(page: UserMainRoute.page),
        AutoRoute(page: HealthCareMainRoute.page),
        ...
        AutoRoute(page: AddressPickerRoute.page),
        AutoRoute(page: HospitalAccountSetupRoute.page),
        AutoRoute(page: AmbulanceAccountSetupRoute.page),
        AutoRoute(page: AmbulanceNotVerifiedRoute.page),
        AutoRoute(page: HospitalDetailsMapRoute.page),
        AutoRoute(page: HospitalDetailsRoute.page),
        AutoRoute(page: HospitalsNearbyRoute.page),
        AutoRoute(page: InformationDetailsRoute.page),
        AutoRoute(page: PanicRoute.page),
        AutoRoute(page: BluetoothListRoute.page),
        AutoRoute(page: UserPostedEventsRoute.page),
